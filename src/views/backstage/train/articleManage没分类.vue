<template>
  <div class="class-box">
    <div class="title-box">文章分类及内容列表</div>
    <!-- 搜索 -->
    ...
    >
      <div class="title-box" style="margin-bottom: 20px">
        ...
        <input type="text" maxlength="13" v-model="editOrAddForm.title" />
      </div>
      <div class="title-box">
        <div class="label">文章作者:</div>
        <input type="text" maxlength="13" v-model="editOrAddForm.author" />
      </div>
      <div class="add-admin flex_col_start">
        ...
        <div class="add_row">
          ...
          <div class="add_col">
            <div class="tips">
              说明：上传图片格式为.jpg或.png，尺寸不超过158px * 158px。
            </div>
            <div class="button">
              <uploadButton
...
export default {
  ...
  methods: {
    ...
    async updateType(type) {
      if (!this.selectIds) {
        this.$message.error(`请勾选需要${type ? "显示" : "隐藏"}的文章！`);
        return;
      }
